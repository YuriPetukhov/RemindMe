document.addEventListener("DOMContentLoaded", function () {
  currentInterface =
    localStorage.getItem("currentInterface") || "userInterface";
  loadUserRoles();
});
...
function loadMenuLinks() {
  ...
  if (
    ...
    $(".menuList").append(
      '<li class="menu__list"><a href="#adminInterface" class="interface__link">Admin Interface</a></li>',
    );
  }
  if (
    ...
    $(".menuList").append(
      '<li class="menu__list"><a href="#teacherInterface" class="interface__link">Teacher Interface</a></li>',
    );
  }
  if (
    ...
    $(".menuList").append(
      '<li class="menu__list"><a href="#studentInterface" class="interface__link">Student Interface</a></li>',
    );
  }
  if (userRoles.includes("ROLE_USER") && currentInterface !== "userInterface") {
    $(".menuList").append(
      '<li class="menu__list"><a href="#userInterface" class="interface__link">User Interface</a></li>',
    );
  }
}
